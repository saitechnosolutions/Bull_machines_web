...
<body data-topbar="dark">
                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" action="" data-url="{{ route('auth.store') }}"
                                        enctype="multipart/form-data" id="initial_login_form">
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input type="text" class="form-control" id="input-phone_num"
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-dark w-100 waves-effect waves-light" type="button"
    ...
    <script>
        function submitForm(formSelector, formUrl, data, event) {
        ...
        validator
            ...
            .onSuccess((event) => {
                ...
                var phonenum = $("#input-phone_num").val();
                ...
                submitForm("#initial_login_form", formUrl, formData);
            });
    </script>
